...
* `thegeekachudev` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `thegeekachudev` - executable or bundle name on disk.
* `thegeekachudev` - display name shown in window titles and about app dialogs.
